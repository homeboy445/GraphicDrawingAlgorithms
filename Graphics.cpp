 ...
 * library for drawing the algorithms, it just imitates the graphics drawing
 * with the help of (n x m) matrix, if the coordinates value is '0' the color
 * would be white, and if it's '1' the color would be red.
 * NOTE: This class is intended for educational & demonstration purposes only.
 */
